...
本实验生成 20 个用户、100 个物品、2000 条用户-物品 EEG 偏好样本；喜欢标签占比为 59.25%。
...
训练共运行 8 个 epoch，最佳验证准确率为 0.8500，对应 epoch 为 8。
...
| F1-score | 0.8621 |
| AUC | 0.9193 |
| Confusion_TN | 103.0000 |
| Confusion_FP | 60.0000 |
| Confusion_FN | 12.0000 |
| Confusion_TP | 225.0000 |
| HitRate@10 | 1.0000 |
| NDCG@10 | 0.9355 |
| Precision@10 | 0.8800 |
